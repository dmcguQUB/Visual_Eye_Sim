  ...
  calculatePercentages() {
    ...
    this.userTests.forEach((test) => {
      ...
      if (index !== -1) {
        ...
        if (
          test.investigationsTest &&
          typeof test.investigationsTest.percentage === 'number'
        ) {
          this.investigationsTestPercentages[index] +=
            test.investigationsTest.percentage;
        }

        if (
          test.diagnosisTest &&
          typeof test.diagnosisTest.percentage === 'number'
        ) {
