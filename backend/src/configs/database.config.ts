...
export const dbConnect =() => {
  // use ! to confirm that it will always be available this value.  
  //{} as ConnectOptions = create an object as COnnect options
  connect(process.env.MONGO_URI!, {

    // tells Mongoose to use the new URL parser for parsing 
    //MongoDB connection strings. This is required when using the MongoDB Node.js driver
